...
{
    internal class OperatingSystemDAO
    {
        ...
        public List<Part> Fetchall()
        {
            ...
            {
                string sqlQuery = "SELECT * FROM dbo.Parts WHERE Type = 'Operating System';";
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        Part os = new Part(reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetString(3), reader.GetString(4), reader.GetInt32(5));
                        returnList.Add(os);
