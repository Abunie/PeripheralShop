...
namespace PeripheralShop.Data
{
    internal class RamDAO
    {
        ...
        public List<Part> Fetchall()
        {
            ...
            {
                string sqlQuery = "SELECT * FROM dbo.Parts WHERE Type = 'RAM';";
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        Part ram = new Part(reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetString(3), reader.GetString(4), reader.GetInt32(5));
                        returnList.Add(ram);
